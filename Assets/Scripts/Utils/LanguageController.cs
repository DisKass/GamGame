...
public class LanguageController
{
	...
	*/
	public LanguageController(string content, string language, bool web)
		{
			if (!web)
			{
			...
			{
				setLanguageWeb(content, language);
			}
		}
		...
		*/
	public void setLanguage(string content, string language)
	{
	...
	*/
	...
	{
		XmlDocument xml = new XmlDocument();
		xml.Load(new System.IO.StringReader(xmlText));
